...
void Graphics::DrawTestTriangle()
{
	...
	const D3D11_INPUT_ELEMENT_DESC ied[] = {
		{"Position",0,DXGI_FORMAT_R32G32_FLOAT,0,0,D3D11_INPUT_PER_VERTEX_DATA,0},			//DXGI_FORMAT doesn't define color, but number of elements and amount of bits there is
